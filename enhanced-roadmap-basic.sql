-- Enhanced Roadmap Schema - Basic Version
-- Just adds the columns without RLS policies for testing

-- 1. Add roadmap enhancement fields to posts table
ALTER TABLE posts 
ADD COLUMN IF NOT EXISTS priority VARCHAR(10) DEFAULT 'medium',
ADD COLUMN IF NOT EXISTS effort_estimate VARCHAR(5) DEFAULT 'M',
...
-- 6. Enable RLS on new tables (but don't add policies yet)
