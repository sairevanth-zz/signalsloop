    ...
    return (
        <div className="min-h-screen p-6 md:p-12" style={{ background: 'linear-gradient(180deg, #FFFAF5 0%, #FFF5EB 100%)' }}>
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                {/* Back Link */}
                <Link href="/" className="inline-flex items-center text-[#5C5C57] hover:text-[#FF4F00] transition-colors">
                ...
                <div className="text-center space-y-4 max-w-2xl mx-auto">
                    ...
                    <h1 className="font-[family-name:var(--font-fraunces)] text-4xl md:text-6xl font-bold tracking-tight text-[#2D2D2A] pb-2">
                        My Score is <span className="text-[#FF4F00]">{results?.score ?? '78'}</span>—What's Yours?
                    </h1>
                                ...
                                <CardContent className="p-8 space-y-8">
                                    ...
                                    <div className="space-y-6">
                                            ...
                                            <div className="flex gap-2">
                                                {(['improving', 'stable', 'declining'] as SentimentTrend[]).map((trend) => (
                                                    <Button
                                                        ...
                                                        className={`flex-1 ${sentimentTrend === trend ? '' : ''}`}
                                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label>Total Feedback Count</Label>
                                                <Input
                                                    type="number"
                                                    min={1}
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-sm font-medium text-gray-600">{praisePercentage}%</span>
                                            </div>
                                            <Slider
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                <Label>Feature Clarity (Theme Concentration)</Label>
                                                <span className="text-sm font-medium text-gray-600">{topThemeConcentration}%</span>
                                            </div>
                                            <Slider
                                                ...
                                                className="py-2"
                                            />
                                            <p className="text-xs text-gray-500">How much of feedback focuses on top 3 themes</p>
                                        </div>
                                    </div>
                        ...
                        >
                            <div className="flex justify-between items-center mb-8">
                                <h2 className="text-3xl font-bold">
                                    Health Score for <span className="text-primary">{productName}</span>
                                </h2>
                            ...
                            <div className="mt-16 text-center space-y-4 pb-12">
                                <h3 className="text-2xl font-bold">Want to track your health score continuously?</h3>
                                ...
                                <div className="flex justify-center gap-4">
                                    ...
                                    <Link href="/demo/feedback">
                                        <Button size="lg" variant="outline">Try Feedback Analysis</Button>
                                    </Link>
                                </div>
                            </div>
                        </motion.div>
