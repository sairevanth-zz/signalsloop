...
export default function DemoNoDepsPage() {
  ...
  const handlePostClick = () => {
    ...
    setMessage(`Post clicked! Total clicks: ${clickCount + 1}`);
      ...
      <header className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">No Dependencies Demo</h1>
              <p className="text-gray-600 mt-1">Testing JavaScript without external libraries</p>
            </div>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-4 space-x-4">
            ...
            <Button variant="outline" asChild>
              <Link href="/js-test-simple">Simple JS Test</Link>
            </Button>
          </div>
        </div>
      </div>
