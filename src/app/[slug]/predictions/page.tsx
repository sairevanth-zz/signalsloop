...
/**
 * Project-Scoped Feature Success Predictions Page
 * 
 * View and generate feature success predictions within the project dashboard context.
 */
...
import { Sparkles, Plus, Loader2, TrendingUp } from 'lucide-react';
import { toast } from 'sonner';
import { getSupabaseClient } from '@/lib/supabase-client';

export default function ProjectPredictionsPage() {
    ...
    async function loadPredictions(projId: string) {
        try {
            setLoading(true);
            const response = await fetch(`/api/predictions?projectId=${projId}`);
