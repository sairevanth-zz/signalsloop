...
export default function ProjectBillingManagePage() {
  ...
  const loadBillingInfo = async () => {
    try {
      ...
      if (project.plan !== 'pro') {
        toast.error('This project is not on a Pro plan');
        router.push(`/${projectSlug}/billing`);
        return;
      }
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            <p className="text-gray-600">
              This project doesn't have an active Pro subscription.
            </p>
            <Button onClick={() => router.push(`/${projectSlug}/billing`)} className="w-full">
              Go to Billing
            </Button>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Button
            variant="ghost"
            onClick={() => router.push(`/${projectSlug}/billing`)}
          ...
          <div>
            ...
            <p className="text-gray-600">Manage your Pro subscription for {billingInfo.name}</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-600">{billingInfo.name}</span>
              </div>
