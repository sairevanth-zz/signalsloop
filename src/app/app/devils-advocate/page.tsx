...
/**
 * Devil's Advocate Dashboard Page
 *
 * Shows all PRDs/specs with their risk alerts.
 */
...
import { ArrowLeft, Shield, AlertTriangle, FileText, Sparkles } from 'lucide-react';
import { getSupabaseClient } from '@/lib/supabase-client';

function DevilsAdvocateContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Hero */}
        <Card className="mb-8 bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 border-red-200">
          <CardHeader>
            ...
            {loadingSpecs ? (
              ...
              <div className="space-y-3">
                {specs.map((spec) => (
                  <Link
                    key={spec.id}
                    href={`/app/spec/${spec.id}#devils-advocate`}
                    className="block"
                  >
