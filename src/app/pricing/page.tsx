...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        '1,000 Smart Replies/month',
        'Hunter: 30/mo + Twitter',
        'Linear & Webhooks',
  ...
  const comparisonFeatures = [
    ...
    { name: 'Feedback Items', free: '50', pro: '1,200', premium: '5,000' },
    { name: 'Team Members', free: '1', pro: '5', premium: '10' },
    { name: 'AI Agents', free: '3', pro: 'All 12', premium: 'All 12' },
    { name: 'Hunter Agent Scans', free: '4/mo', pro: '30/mo', premium: '30/mo + Twitter' },
