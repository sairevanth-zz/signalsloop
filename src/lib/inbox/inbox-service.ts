...
let _inboxServiceInstance: InboxService | null = null;

function getInboxService(): InboxService {
  if (!_inboxServiceInstance) {
    _inboxServiceInstance = new InboxService();
  }
  return _inboxServiceInstance;
}

// For backwards compatibility - proxy object that delays instantiation
export const inboxService = {
  listItems: (...args: Parameters<InboxService['listItems']>) =>
    getInboxService().listItems(...args),
  getItem: (...args: Parameters<InboxService['getItem']>) =>
    getInboxService().getItem(...args),
  markAsRead: (...args: Parameters<InboxService['markAsRead']>) =>
    getInboxService().markAsRead(...args),
  toggleStarred: (...args: Parameters<InboxService['toggleStarred']>) =>
    getInboxService().toggleStarred(...args),
  updateStatus: (...args: Parameters<InboxService['updateStatus']>) =>
    getInboxService().updateStatus(...args),
  archiveItem: (...args: Parameters<InboxService['archiveItem']>) =>
    getInboxService().archiveItem(...args),
  markAsSpam: (...args: Parameters<InboxService['markAsSpam']>) =>
    getInboxService().markAsSpam(...args),
  recordReply: (...args: Parameters<InboxService['recordReply']>) =>
    getInboxService().recordReply(...args),
  convertToPost: (...args: Parameters<InboxService['convertToPost']>) =>
    getInboxService().convertToPost(...args),
  bulkUpdateStatus: (...args: Parameters<InboxService['bulkUpdateStatus']>) =>
    getInboxService().bulkUpdateStatus(...args),
  getStats: (...args: Parameters<InboxService['getStats']>) =>
    getInboxService().getStats(...args),
  getCustomerFeedback: (...args: Parameters<InboxService['getCustomerFeedback']>) =>
    getInboxService().getCustomerFeedback(...args),
  getSimilarItems: (...args: Parameters<InboxService['getSimilarItems']>) =>
    getInboxService().getSimilarItems(...args),
  listCustomers: (...args: Parameters<InboxService['listCustomers']>) =>
    getInboxService().listCustomers(...args),
  getCustomer: (...args: Parameters<InboxService['getCustomer']>) =>
    getInboxService().getCustomer(...args),
  updateCustomer: (...args: Parameters<InboxService['updateCustomer']>) =>
    getInboxService().updateCustomer(...args),
};
