...
export function NotificationSettings({
  ...
  if (!isSubscribed) {
    return (
      <div className={cn('p-6 bg-slate-800/50 rounded-lg text-center', className)}>
        <BellOff className="w-12 h-12 text-slate-500 mx-auto mb-4" />
        <h3 className="text-lg font-medium text-white mb-2">Notifications Disabled</h3>
        <p className="text-sm text-slate-400 mb-4">
          Enable push notifications to receive alerts for critical feedback and updates.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="space-y-1">
        <p className="text-sm text-slate-400 mb-3">Choose which notifications you want to receive:</p>
