            ...
            <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
                ...
                <div className="w-full lg:w-[320px] xl:w-[380px] flex-shrink-0">
                    ...
                    >
                        ...
                        <Link href={`/${projectSlug}/ai-insights`} style={{ display: 'block', marginBottom: '16px', textDecoration: 'none' }}>
                            <div style={{
                                padding: '14px',
                                borderRadius: '12px',
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    <span style={{ fontSize: '13px', fontWeight: 500, color: (dashboardData?.sentimentScore || 0.5) >= 0.6 ? '#10b981' : (dashboardData?.sentimentScore || 0.5) >= 0.4 ? '#fbbf24' : '#ef4444' }}>
                                    ...
                                    {dashboardData?.recentActivity && dashboardData.recentActivity.length > 0 ? (
                                        dashboardData.recentActivity.slice(0, 3).map((activity, index) => (
                                            <ActivityItem
                                                ...
                                                icon={<MessageSquare style={{ width: '16px', height: '16px', color: activity.sentiment && activity.sentiment > 0.5 ? '#14b8a6' : '#fbbf24' }} />}
                                        ...
                                        <div style={{
                                            ...
                                            <Inbox style={{ width: '28px', height: '28px', margin: '0 auto 10px', opacity: 0.5 }} />
...
function ActionCard({
    ...
    return (
        <div style={{
            ...
            boxShadow: isDark
                ? `0 0 60px ${accentColor}${glowIntensity}, 0 0 30px ${accentColor}50, inset 0 0 30px ${accentColor}${insetGlow}`
                : `0 0 30px ${accentColor}30, 0 4px 12px rgba(0,0,0,0.1)`,
            overflow: 'hidden',
            transition: 'all 0.3s ease',
            height: '320px',
            display: 'flex',
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{
                    ...
                    marginBottom: '12px',
                    boxShadow: isDark ? `0 0 16px ${accentColor}40` : 'none'
                }}>
                    {icon}
                </div>
                ...
                <Link
                    ...
                    style={{
                        ...
                        textDecoration: 'none',
                        boxShadow: isDark
                            ? `0 6px 24px ${accentColor}70, 0 0 40px ${accentColor}50, 0 0 60px ${accentColor}30`
