        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            {usageInfo && !usageInfo.isPro && (
              <div className="text-xs text-teal-700 bg-white/70 border border-teal-200 rounded-full px-3 py-1">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-teal-200 rounded-md focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            />
          </div>
