-- Mission Control Dashboard Migration (Clean Version)
...
DROP FUNCTION IF EXISTS get_today_briefing(UUID) CASCADE;
DROP FUNCTION IF EXISTS get_dashboard_metrics(UUID) CASCADE;
DROP FUNCTION IF EXISTS update_daily_briefings_timestamp() CASCADE;

-- ============================================================================
-- 2. Create daily_briefings table
-- ============================================================================
...
-- ============================================================================
CREATE INDEX idx_daily_briefings_project_id ON daily_briefings(project_id);
...
CREATE UNIQUE INDEX idx_daily_briefings_project_date_unique
...
-- ============================================================================
-- 5. RLS Policies for daily_briefings
-- ============================================================================
...
-- ============================================================================
CREATE FUNCTION update_daily_briefings_timestamp()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
-- ============================================================================
-- 7. Create helper function to get today's briefing
-- ============================================================================
CREATE FUNCTION get_today_briefing(p_project_id UUID)
RETURNS TABLE (
  id UUID,
  project_id UUID,
  content JSONB,
...
-- ============================================================================
-- 8. Create function to get dashboard metrics
-- ============================================================================
