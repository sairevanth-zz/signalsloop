...
-- Recreate the sync_account_billing_from_project function with SECURITY DEFINER so
-- that project inserts coming from authenticated clients can upsert the billing
-- profile without hitting RLS on account_billing_profiles.
